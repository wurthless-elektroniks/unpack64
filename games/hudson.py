...
#
# Resource blob immediately follows bootexe. Header is:
# - 4 bytes 0xDEADDAED
# - 4 bytes number of files in blob, minus 1
# - 4 bytes offset for file table relative to start of resource table
# - 4 bytes offset for file data relative to start of resource table
#
# Then n entries of 8 bytes:
# - 4 bytes start offset of filedata (0xFFFFFFFF = end of filetable)
# - 4 bytes sizeof data
#
# This game uses lzssbomberman compression.
#
